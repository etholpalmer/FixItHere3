...
For a proof of concept, I would aggressively reduce the scope. The purpose of the demo is not to prove the business rules—it is to prove the experience.

If someone can watch a five-minute demonstration and say, “I understand exactly how this marketplace works,” you’ve succeeded.

I’d target something that can be built in 2–4 weeks instead of several months.
